...
public class AltaPromocionSteps {
	...
	void screenshot(String nombreCapture) {
		// Capturar y adjuntar un screenshot del paso
		byte[] screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
		this.scenario.attach(screenshot, "image/png", nombreCapture);
	}
	...
	public void pantallaPromocionesFechaHasta() {
		...
		// tomar fecha actual considerada como fecha desde y sumar 3 meses de vigencia
		// en la promocion
		LocalDate fechaActual = LocalDate.now();
	...
	public void pantallaPromocionesSistemaFinanciacion(String sistemaFinanciacion) {
		// ingresar datos de Sistema de Financiacion en el formulario de la pantalla
		// promociones
	...
	public void pantallaPromocionesSistemaFinanciacionDinamico() {
		...
		// Interactuar con el dropdown y seleccionar el sistema de financiaciÃ³n
		WebElement dropdown = driver.findElement(By.name("IdSistemaFinanciacion"));
		dropdown.findElement(By.xpath("//option[. = '" + sistemaFinanciacion + "']")).click();
	...
	public void pantallaPromocionesPorcDescuento(String porcDescuento) {
		// ingresar datos de Porcentaje de Descuento en el formulario de la pantalla
		// promociones
	...
	public void pantallaPromocionesTopeDescuento(String topeDescuento) {
		// ingresar datos de Tope de Descuento en el formulario de la pantalla
		// promociones

		driver.findElement(By.name("TopeDescuento")).sendKeys(topeDescuento);
		screenshot("Alta promoción - 1era pantalla - 1");
	}
	...
	public void pantallaPromocionesTopeDescuentoDinamico() {
		...
		screenshot("Alta promoción - 1era pantalla - 2do screenshot");
	}
	...
	public void pantallaPromocionesParteAdquirente(String parteAdquirente) {
		// ingresar datos de Parte Adquirente en el formulario de la pantalla
		// promociones
	...
	public void pantallaPromocionesSeleccionarDiasPromo() {
		...
		screenshot("Alta promoción - 2da pantalla");
	...
	public void pantallaComercios() {
		// Pantalla de seleccion de comercios
		{
			wait.until(ExpectedConditions
					.presenceOfElementLocated(By.cssSelector("select.selectTipoComercio:nth-child(2)")));
		}
	}
	...
	public void pantallaComerciosSeleccionarTipoComercio(String seleccionarTipoComercios) {
		// ingresar datos de tipo de comercio en el formulario de la pantalla
		// promociones
		{
		...
		screenshot("Alta promoción - 3era pantalla");
	...
	public void pantallaTarjetasDesde(String tarjetaDesde) {
		// ingresar datos de tipo de Tajeta desde en el formulario de la pantalla
		// promociones
	...
	public void pantallaTarjetasHasta(String tarjetaHasta) {
		// ingresar datos de tipo de Tajeta Hasta en el formulario de la pantalla
		// promociones
		...
		screenshot("Alta promoción - 4ta pantalla");
	...
	public void altaPromociones() {		
		...
		screenshot("Alta promoción - confirmacion");
		Assert.assertTrue(driver.findElement(By.xpath("//h1[contains(.,'Alta Exitosa.')]")).isDisplayed(),
